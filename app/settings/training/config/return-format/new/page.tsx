    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">New Return Format</h1>
          <p className="text-gray-600 mt-2">Define the JSON schema for the expected output</p>
        </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                placeholder='{"totalWeeks": 16, "phases": [...], "week": {...}}'
              />
            </div>
            ...
            >
              {saving ? 'Saving...' : 'Save Return Format'}
            </button>
          </div>
        </div>
      </div>
